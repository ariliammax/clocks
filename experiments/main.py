...
class ExperimentParameters:
    ...
    PARAMETERS = [
        ...
        ["A2", [1/6, 1, 1], [10002, 20002, 30002], 10],
        ["A3", [1/6, 1/6, 1], [10003, 20003, 30003], 10],
        ["A4", [1/6, 1/2, 1], [10004, 20004, 30004], 10],
...
@pytest.mark.skipif(True, reason='Don\'t skip this if you would like to collect data.')
